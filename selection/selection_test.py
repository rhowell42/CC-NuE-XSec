...
def plotRecoKin(mc, chainwrapper, outfile):
    ...
    #chainwrapper.Add("/exp/minerva/app/users/rhowell/AL9_test/CC-NuE-XSec/MasterAnaDev_mc_AnaTuple_run00110000_Playlist.root")
    chainwrapper.Add("/exp/minerva/app/users/rhowell/AL9_test/CC-NuE-XSec/MasterAnaDev_mc_AnaTuple_run00123000_Playlist.root")
...
if __name__ == "__main__":
    ...
    for st in AnalysisConfig.data_types:
        ...
        if Reco :
            ...
            plotRecoKin(st=="mc",None, output_file)
        if st=="mc" and Truth:
