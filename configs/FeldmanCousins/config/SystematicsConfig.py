...
DETECTOR_RESPONSE_ERROR_GROUPS = {
    "Angular resolution": ["eltheta","Proton_Angle"],
...
CONSOLIDATED_ERROR_GROUPS_CONFIG = {
    ...
    "Interaction model": [GENIE_ERROR_GROUPS,FSI_ERROR_GROUPS,SCATTERING_SYS],
    ...
    "Electron Energy Scale" : [{"ElectronScale":["ElectronScale"]}]
...
ERROR_GROUPS_CONFIG = {
    "GENIE":GENIE_ERROR_GROUPS,
    "GEANT":GEANT_ERROR_GROUPS,
