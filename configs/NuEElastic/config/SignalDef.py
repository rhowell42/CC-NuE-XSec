...
TRUTH_CATEGORIES["nue"] = lambda event: IsElastic(event) and IsNue(event)
TRUTH_CATEGORIES["numu"] = lambda event: IsElastic(event) and IsNumu(event)
TRUTH_CATEGORIES["anue"] = lambda event: IsElastic(event) and IsNueBar(event)
TRUTH_CATEGORIES["anumu"] = lambda event: IsElastic(event) and IsNumuBar(event)
