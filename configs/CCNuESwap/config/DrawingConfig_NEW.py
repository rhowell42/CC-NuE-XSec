...
Categories["Other"] = {
    "title":"Others",
    #"cate" : {"CCNu","NonPhaseSpace","NonFiducial","Other"},#
    #"cate" : {"CCNu","Other"},#
    "cate" : {"Other"},#
    "color" : COLORS[7]
}
...
SignalDecomposition = {
    ...
    "Background" : {
        "title" : "Backgrounds",
        #"cate" : {"NCDiff", "CCPi0", "NCPi0", "NCCohPi0","NuEElastic","Other","NonFiducial","NonPhaseSpace","CCNu"}, 
        #"cate" : {"NCDiff", "CCPi0", "NCPi0", "NCCohPi0","NuEElastic","Other","CCNu"}, 
        "cate" : {"NCDiff", "CCPi0", "NCPi0", "NCCohPi0","NuEElastic","Other"}, 
        "color": COLORS[5]
    }
    # "CCNuEAntiNu" : {
    #     "title" : "CC #bar{#nu_{e}}",
...
SignalBackground = {
    ...
    "Background" : {
        ...
        "cate": {"CCPi0","Other","NCDiff","NuEElastic","NCCohPi0","NCPi0"},
        "color": COLORS[4]
    }
}
