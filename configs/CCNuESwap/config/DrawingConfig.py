...
SignalDecomposition = {
    ...
    #"Background" : {
    #    "title" : "Backgrounds",
    #    "cate" : {"NCDiff", "CCPi0", "NCPi0", "NCCohPi0","NuEElastic","CCPi0Proton","NCPi0Proton","CCPi","NCPi","CCOther","NCOther","Other"}, 
    #    "color": COLORS[5]
    #}
}
...
DefaultPlotters={
    ...
    "err": {"func": PlotTools.PrepareErr,
            "args":(BackgroundDecomposition,True,False,CONSOLIDATED_ERROR_GROUPS)},
