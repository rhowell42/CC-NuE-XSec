...
void mergeMultipleStategies() {
  ...
  std::string file_path = "/exp/minerva/data/users/hsu/nu_e/";
  std::vector<std::string> hist_names;
  hist_names.push_back("Eavail_Lepton_Pt_bkgSubed");
  hist_names.push_back("Eavail_q3_bkgSubed");
  std::vector<std::string> file_names;
  //file_names.push_back("bkgfit_me_q3_tune_RHC_Scale_Sarah.root");
  ...
  char* cv_file = "bkgfit_me_pi0pt_tune_RHC_Scale_Sarah.root";
  TH2D* cv_base = NULL;
  char* out_file = "bkgfit_me_multi4_tune_RHC_Scale_Sarah.root";
