...
def DrawUnfoldingResult(h_unfolded,h_truth,h_cov,name):
    ...
    tmp.Draw("COLZ")
    c.Print("/exp/minerva/data/users/hsu/tests/"+name+"ratio.png")
    h_cov.Draw("COLZ")
    c.Print("/exp/minerva/data/users/hsu/tests/"+name+"cov.png")
...
if __name__ == '__main__':
    f = ROOT.TFile.Open('/exp/minerva/data/users/hsu/nu_e/kin_dist_mcme_RHC_Scale_Sarah.root')
