...
int printEfficiencyNPurity() {
  TFile* f = TFile::Open("/exp/minerva/data/users/hsu/nu_e/cut_study_mcme1B_nx_wcut_real_Sarah.root");
  //TFile* fsig = TFile::Open("/exp/minerva/data/users/hsu/nu_e/truth_dist_mcme1B_nx_collab1_LLR.root")
  const char* const var = "tQ3";
