...
def GetOscillatedHistogramCategories(histogram, m, U_e4, U_mu4,U_tau4,plotArgs = []):
    ...
    bottom1 = ROOT.TPad("Ratio", "Ratio", 0, bottomFraction/2, 1, bottomFraction+margin)
    bottom2 = ROOT.TPad("Ratio", "Ratio", 0, 0, 1, bottomFraction/2+margin)
    ...
    bottom2.cd()
    bottom2.SetTopMargin(0)
    bottom2.SetBottomMargin(0.3)
    ratio.Draw()
